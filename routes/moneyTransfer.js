                ...
                if(result){
                    moneyTransfer(fromAccNo,sendToAccNo,amount,(err,result)=>{
                        if(err){
                            ...
                            res.render('customerAccountOnline',{msg:"Successfully send Rs. "+amount+" from "+fromAccNo+" to "+sendToAccNo,accNo:fromAccNo,customer:req.session.username,accType:"saving"});
                        }
                    });
                }else{
